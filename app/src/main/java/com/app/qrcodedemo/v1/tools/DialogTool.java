...
public class DialogTool extends Dialog {
    ...
    public DialogTool(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public DialogTool(Context context, boolean cancelable, OnCancelListener cancelListener) {
     ...
     */
    public DialogTool(Context context, float alpha, int gravity) {
        super(context);
